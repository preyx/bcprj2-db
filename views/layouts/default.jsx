    ...
    <html lang='en'>
      ...
      <body>
        ...
        <nav className='navbar navbar-light bg-primary flexContainer'>
          ...
          {/* <!-- Collapse button --> */}
          <button
            className='centerBurgerMenu dropdown navbar-toggler toggler-example red darken-3' type='button' data-toggle='collapse'
            data-target='#navbarSupportedContent41' aria-controls='navbarSupportedContent41' aria-expanded='false'
            aria-label='Toggle navigation'
          ><span className='white-text'><i className='fas fa-bars fa-1x' /></span>
          </button>
          {/* <!-- Collapsible content --> */}
          <div className='collapse navbar-collapse show' id='navbarSupportedContent41'>
            <form className='form-inline'>
              <div className='input-group'>
                ...
                <input
                  type='text' className='form-control' placeholder='Enter Username Here' aria-label='Username'
